...
// ============================================================================
// 第一部分：全局变量与双核异步共享内存 (严格保持 7 阵元一致)
// ============================================================================
#define FFT_N 1024
#define NUM_MICS 7
#define NUM_PAIRS 21
...
// ============================================================================
// 第二部分：SRP-PHAT 数学管线 (严格对标 MATLAB 宽带能量叠加)
// ============================================================================
...
// 录音兵接口：提取 7 颗用于测向，波束成型只使用前 6 颗提纯！
